...
- _MappingPackageEventMessage_ (for mapping suite related events/processes)
...
- _MappingPackageEventMessage_ -> *mapping_suite_events*
...
from src.ted_sws.event_manager.model.event_message import TechnicalEventMessage, NoticeEventMessage
from src.ted_sws.event_manager.services.logger_from_context import get_logger_from_dag_context, handle_event_message_metadata_dag_context
...
====
from src.ted_sws.event_manager.services.logger_from_context
====
[source]
----
...
----
====
from src.ted_sws.event_manager.services.log
====
[source]
----
...
===== Logging decorators:
====
from src.ted_sws.event_manager.adapters.event_log_decorator
====
[source]
----
def event_log(
