...
from src.ted_sws.alignment_oracle.model.limes_config import LimesConfigParams, LimesDataSource, LimesDataResult

TEMPLATES = Environment(loader=PackageLoader("src.ted_sws.alignment_oracle.resources", "templates"))
