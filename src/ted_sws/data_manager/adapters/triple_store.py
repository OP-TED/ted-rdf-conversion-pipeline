...
from src.ted_sws.data_manager.adapters.sparql_endpoint import TripleStoreEndpointABC, SPARQLTripleStoreEndpoint
...
class FusekiAdapter(TripleStoreABC):
    ...
    def __init__(self, host: str = None,
        ...
        self.host = host if host else config.FUSEKI_ADMIN_HOST
        self.user = user if user else config.FUSEKI_ADMIN_USER
        self.password = password if password else config.FUSEKI_ADMIN_PASSWORD
