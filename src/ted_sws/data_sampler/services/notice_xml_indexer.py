...
from src.ted_sws.core.adapters.xml_preprocessor import XMLPreprocessor
from src.ted_sws.core.model.metadata import XMLMetadata
...
from src.ted_sws.resources import XSLT_FILES_PATH
