...
from src.ted_sws.event_manager.adapters.event_handler import EventHandler
from src.ted_sws.event_manager.adapters.event_handler_config import EventHandlerConfig
