...
from src.ted_sws.data_manager.adapters.triple_store import TripleStoreABC
from src.ted_sws.master_data_registry.resources import RDF_FRAGMENT_BY_URI_SPARQL_QUERY_TEMPLATE_PATH, \
