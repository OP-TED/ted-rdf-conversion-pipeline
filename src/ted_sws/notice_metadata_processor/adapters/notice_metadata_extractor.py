...
from src.ted_sws.core.model.metadata import LanguageTaggedString, CompositeTitle, EncodedValue
from src.ted_sws.notice_metadata_processor.adapters.xpath_registry import EformsXPathRegistry, DefaultXPathRegistry
