...
def get_notice_ids_by_metadata_field_value(field_name: str, field_value: str, mongodb_client: MongoClient) -> List[str]:
    """
...
def get_notice_ids_by_form_number(form_number: str, mongodb_client: MongoClient) -> List[str]:
    ...
    :return:
    """
    return get_notice_ids_by_metadata_field_value(field_name=NOTICE_METADATA_FORM_NUMBER_FIELD_NAME,
...
def get_notice_ids_by_eforms_subtype(eforms_subtype: str, mongodb_client: MongoClient) -> List[str]:
    ...
    :return:
    """
    return get_notice_ids_by_metadata_field_value(field_name=NOTICE_METADATA_EFORMS_SUBTYPE_FIELD_NAME,
