...
from ted_sws.workbench_tools.notice_validator.cli import DEFAULT_RDF_FOLDER
from ted_sws.workbench_tools.notice_validator.cli.cmd_xpath_coverage_runner import JSON_REPORT_FILE as XPATH_JSON_FILE, \
