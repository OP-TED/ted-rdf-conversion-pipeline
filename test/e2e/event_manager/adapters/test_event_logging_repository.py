from src.ted_sws.event_manager.adapters.event_logging_repository import EventLoggingRepository
from src.ted_sws.event_manager.model.event_message import EventMessage
...
def test_event_logging_repository_add():
    ...
    event_message = EventMessage(**{"message": event_message_message})
