...
from src.ted_sws.data_manager.adapters.triple_store import RDF_MIME_TYPES
from test import TEST_DATA_PATH


@pytest.fixture
def file_system_repository_path():
    return TEST_DATA_PATH / "notice_transformer" / "mapping_package_processor_repository"
