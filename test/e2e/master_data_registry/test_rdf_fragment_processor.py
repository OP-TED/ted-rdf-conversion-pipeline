...
from src.ted_sws.data_manager.adapters.triple_store import FusekiAdapter
from src.ted_sws.master_data_registry.services.rdf_fragment_processor import get_rdf_fragment_by_cet_uri_from_notice, \
