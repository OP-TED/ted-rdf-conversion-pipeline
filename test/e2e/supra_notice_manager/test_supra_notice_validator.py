...
import pytest
from src.ted_sws.core.model.manifestation import XMLManifestation, ValidationSummaryReport
from src.ted_sws.core.model.notice import Notice
from src.ted_sws.supra_notice_manager.services.daily_supra_notice_manager import \
