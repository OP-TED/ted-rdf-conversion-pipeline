...
@given('a mapping suite for F03 is available in mapping suite repository', target_fixture="mapping_package_repository")
...
@given('a mapping suite for F03 is not available in mapping suite repository',
       target_fixture="mapping_package_repository")
def a_mapping_package_for_f03_is_not_available_in_mapping_package_repository(clean_mapping_package_repository):
...
def the_notice_eligibility_checking_is_executed(normalised_notice, mapping_package_repository):
    """the notice eligibility checking is executed."""
    notice_eligibility_checker(notice=normalised_notice, mapping_package_repository=mapping_package_repository)
