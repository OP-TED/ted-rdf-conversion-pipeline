...
from src.dags.daily_materialized_views_update import DAILY_MATERIALISED_VIEWS_DAG_NAME
from src.dags.fetch_notices_by_date import DAG_ID as FETCHER_DAG_NAME
