...
import pytest
import rdflib
from src.ted_sws.data_manager.adapters.sparql_endpoint import SPARQLStringEndpoint, TripleStoreEndpointABC, \
    SPARQLFileEndpoint
from src.ted_sws.master_data_registry.resources import TRIPLES_BY_CET_URI_SPARQL_QUERY_TEMPLATE_PATH, \
