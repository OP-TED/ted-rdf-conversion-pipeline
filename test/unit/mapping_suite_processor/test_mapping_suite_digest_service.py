...
def test_replace_digest_api_address_for_mapping_suite(fake_mapping_suite):
    ...
    update_digest_api_address_for_mapping_package(fake_mapping_suite, current_digest_api_address,
    ...
    update_digest_api_address_for_mapping_package(fake_mapping_suite, current_digest_api_address, new_digest_api_address)
    for rml_mapping_rule in fake_mapping_suite.transformation_rule_set.rml_mapping_rules:
