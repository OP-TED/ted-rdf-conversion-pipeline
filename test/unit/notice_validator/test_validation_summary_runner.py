...
from src.ted_sws.notice_validator.services.validation_summary_runner import validation_summary_report_notice_by_id, \
...
def test_validation_summary_runner(fake_validation_notice, mongodb_client):
    ...
    assert not notice.validation_summary.notices
