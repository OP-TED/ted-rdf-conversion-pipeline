...
def test_notice_fetcher_by_identifier():
    ...
    notice = NoticeFetcher(ted_api_adapter=TedAPIAdapter(request_api=TedRequestAPI())).fetch_notice_by_id(
...
def test_notice_fetcher_by_search_query():
    ...
    notices = NoticeFetcher(ted_api_adapter=TedAPIAdapter(request_api=TedRequestAPI())).fetch_notices_by_query(
        query=query)
...
def test_notice_fetcher_by_date_range():
    notices = NoticeFetcher(ted_api_adapter=TedAPIAdapter(request_api=TedRequestAPI())).fetch_notices_by_date_range(
