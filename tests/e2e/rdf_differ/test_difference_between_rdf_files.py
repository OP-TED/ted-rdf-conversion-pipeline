...
from ted_sws.rdf_differ.services.difference_between_rdf_files import _rdf_differ_html_report
...
def test_rdf_differ_service(technical_mapping_f03_file_path, technical_mapping_f06_file_path):
    differences_between_files = _rdf_differ_html_report(technical_mapping_f03_file_path, technical_mapping_f06_file_path)
