...
from dags.dags_utils import parse_notice_statuses_from_string, has_notices_with_failure_status
from dags.operators.DagBatchPipelineOperator import NOTICE_IDS_KEY, NOTICES_WITH_STATUS_KEY
    ...
    with patch('dags.notice_processing_pipeline.smart_xcom_pull') as mock_xcom_pull:
        ...
        with patch('dags.notice_processing_pipeline.NOTICE_SUCCESS_STATUSES', success_statuses):
            try:
                ...
                from dags.notice_processing_pipeline import notice_processing_pipeline
