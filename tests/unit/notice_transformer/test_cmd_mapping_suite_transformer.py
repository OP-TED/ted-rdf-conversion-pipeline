...
from ted_sws.notice_transformer.entrypoints.cmd_mapping_suite_transformer import run as cli_run
...
def test_cmd_transformer(caplog, fake_rml_mapper, fake_mapping_suite_id, fake_repository_path):
    cli_run(
        ...
        opt_mappings_path=fake_repository_path,
...
def test_cmd_transformer_with_invalid_serialization(caplog, fake_rml_mapper, fake_mapping_suite_id,
...
def test_cmd_transformer_with_not_package(caplog, fake_rml_mapper, fake_not_mapping_suite_id,
                                          fake_fail_repository_path):
    cli_run(
        mapping_suite_id=fake_not_mapping_suite_id,
        opt_mappings_path=fake_fail_repository_path,
        rml_mapper=fake_rml_mapper
    )
...
def test_cmd_transformer_with_failed_package(caplog, fake_rml_mapper, fake_failed_mapping_suite_id,
                                             fake_fail_repository_path):
    cli_run(
...
def test_cmd_transformer_with_no_suite_id(caplog, fake_rml_mapper, fake_repository_path):
    cli_run(
        opt_mappings_path=fake_repository_path,
        rml_mapper=fake_rml_mapper
    )
